            ...
            <form onSubmit={handleSubmit}>
                <div className="ask-form-container">
                    ...
                    <label htmlFor="ask-ques-body">
                        <h4>Body</h4>
                        <p>Include all the information someone would need to your question</p>
                    ...
                    <label htmlFor="ask-ques-tag">
                        ...
                        <input type="text" onChange={(e) => {setQuestionTags(e.target.value.split(' '))}} placeholder='e.g. (xml typescript wordpress)' id='ask-ques-tag'/>
                    </label>
                </div>
